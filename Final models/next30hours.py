...
df = pd.read_csv( "C:/Users/Phipr/Desktop/Past Research/Completed Projects/LSTM_Solar_Prediction/Hanoi_hourly.csv",  index_col='datetime', parse_dates=True)
...
#PREDICTION FOR THE NEXT 30 hours, using last 10 hours input for 1st hour output
...
#PLOTTING NEXT 30 hours PREDICTIONS
